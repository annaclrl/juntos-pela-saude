...
const Cadastro = () => {
  ...
  function getUsuarios(): CadastroUsuarioProps[] {
    const usuariosJSON = localStorage.getItem("usuarios");
    return usuariosJSON ? JSON.parse(usuariosJSON) : [];
  }

  function salvarUsuarios(usuarios: CadastroUsuarioProps[]) {
  ...
  function handleCadastro(e: React.FormEvent) {
    ...
    const novoUsuario: CadastroUsuarioProps = { nome, email, cpf, senha };
